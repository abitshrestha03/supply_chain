      ...
      <div className="bg-gray-50 p-4 rounded mb-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="grid grid-rows-2 gap-4">
            <div className="mb-2 rounded-lg shadow-md bg-white px-4 pb-4">
              <div className="flex items-center">
                <h2 className="text-lg font-normal w-[10vw] mt-4">
                  Order Receipt
                </h2>
                <span className="text-[#FF0000] text-xs px-2 rounded-sm py-1 bg-[#FF00001F]">
                  Damaged Goods
                </span>
              </div>
              <p className="text-sm text-[#00000099] mb-1">
                Order ID: <span className="text-black">#ABC249Z</span>
              </p>
              <p className="text-sm text-[#00000099] mb-1">
                Date: <span className="text-black">2024/12/03</span>
              </p>
              <p className="text-sm text-[#00000099] mb-1">
                Customer ID: <span className="text-black">#CUS123456</span>
              </p>
              <p className="text-sm text-[#00000099] mb-1">
                Sales Representative:{" "}
                <span className="text-black">John Doe</span>
              </p>
              <p className="text-sm text-gray-600 border-b-2 border-gray-300 pb-4">
                Billing Address:{" "}
              ...
              <table className="w-full text-left mt-4">
                ...
                <tbody>
                  <tr className="text-sm text-gray-700">
                    <td className="py-2">Sunscreen</td>
                    <td>Rs 4.00</td>
                    <td>x12</td>
                    <td>Rs 48.00</td>
                  </tr>
                  <tr className="text-sm text-gray-700">
                    <td className="py-2">Wai Wai Noodles</td>
                    <td>Rs 35.00</td>
                    <td>x15</td>
                    <td>Rs 498.75</td>
                  </tr>
                  <tr className="text-sm text-gray-700">
                    <td className="py-2">Packaged Beans</td>
                    <td>Rs 25.00</td>
                    <td>x15</td>
                    <td>Rs 375.00</td>
                  </tr>
